...
const aboutUsController = function (request, response) {
  renderPageWithAuthStatus(request, response, "aboutUS", {showAccountCreated : false , confirmstate : false , showIndexOnUnauthenticated : false , page : "debugTextOnly" ,changeOnProfile :false});
};
