  ...
  databaseUser
    ...
    .then((fetchedUser) => {
      ...
      if (!isAccountActive(fetchedUser.status)) {
        ...
        response.render("index", { isUserLogged: false , showAccountCreated : true , confirmstate : true , showIndexOnUnauthenticated : false , page : "debugOnlyText", changeOnProfile :false});
      } else {
        response.render("index", { isUserLogged: false , showAccountCreated : true , confirmstate : false , showIndexOnUnauthenticated : false , page : "debugOnlyText", changeOnProfile :false});
      }
